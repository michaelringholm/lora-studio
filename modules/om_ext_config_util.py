...
from . import om_ext_train_util
from .om_ext_train_util import (
  DreamBoothSubset,
  FineTuningSubset,
  ControlNetSubset,
  DreamBoothDataset,
...
if __name__ == "__main__":
  ...
  parser = argparse.ArgumentParser()
  om_ext_train_util.add_dataset_arguments(parser, config_args.support_dreambooth, config_args.support_finetuning, config_args.support_dropout)
  om_ext_train_util.add_training_arguments(parser, config_args.support_dreambooth)
  argparse_namespace = parser.parse_args(remain)
  om_ext_train_util.prepare_dataset_args(argparse_namespace, config_args.support_finetuning)
